...
public:
 explicit AnimationController(gltfio::Animator*a=nullptr):m_animator(a){}
 void setAnimator(gltfio::Animator*a){m_animator=a;m_state=PlayerAnimState::IDLE;m_clip=0;m_time=0;}
...
private:gltfio::Animator*m_animator{};PlayerAnimState m_state{PlayerAnimState::IDLE};size_t m_clip{};float m_time{};
};
}